...
export const register = async (req: Request, res: Response) => {
    try {
        const registerUserInput = new RegisterUserInput(req.body.name, req.body.email, req.body.password);
...
export const login = async (req: Request, res: Response) => {
    try {
        const loginUserInput = new LoginUserInput(req.body.email, req.body.password);
